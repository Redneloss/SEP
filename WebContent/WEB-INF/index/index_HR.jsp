...
<body>
    ...
    <div class="container mt-4 mb-4">
        <div class="pb-2 mt-4 mb-4 border-bottom">
            <h1>Home Page - HR team</h1>
        </div>
        
        <div class="row justify-content-between">
	        <div class="card-deck col-md-4 col-sm-6">
                <a class="card border-primary bg-light text-primary p-4 mt-3 mb-3" style="text-decoration: none;" href="/SEP/WorkItemListRR">
                    <div class="card-link text-center">
                        <i class="far fa-handshake"></i> View Recruitment Requests</div>
                </a>
            </div>
		</div>
    </div>
